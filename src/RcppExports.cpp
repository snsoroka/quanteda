...
// qatd_cpp_recompile
List qatd_cpp_recompile(const List& texts_, const CharacterVector types_);
RcppExport SEXP quanteda_qatd_cpp_recompile(SEXP texts_SEXP, SEXP types_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const List& >::type texts_(texts_SEXP);
    Rcpp::traits::input_parameter< const CharacterVector >::type types_(types_SEXP);
    rcpp_result_gen = Rcpp::wrap(qatd_cpp_recompile(texts_, types_));
    return rcpp_result_gen;
END_RCPP
}
