...
#' many users will find the non-negation sentiment forms of the LSD adequate 
#' for sentiment analysis, Young and Soroka (2012) did find a small but 
#' non-negligible increase in performance when accounting for negations. 
#' Users wishing to test this or include the negations are encouraged to 
#' subtract negated positive words from the count of positive words, and 
#' subtract the negated negative words from the negative count.  Young and 
#' Soroka (2012) also suggest the use of a pre-processing script to remove 
#' specific cases of some words (i.e., “good bye,” or “nobody better,” which 
#' should not be counted as positive).  Pre-processing scripts are available 
#' at http://lexicoder.com.
#' 
